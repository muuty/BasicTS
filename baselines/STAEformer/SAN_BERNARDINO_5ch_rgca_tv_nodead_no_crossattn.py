...
Ablation: disable_cross_attn=True (Stage 1 + Stage 3 only).

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/STAEformer/SAN_BERNARDINO_5ch_rgca_tv_nodead_no_crossattn.py', gpus='1')"
"""
import os
import sys
import torch
...
CFG = EasyDict()
CFG.DESCRIPTION = 'Ablation: no cross-attn (Stage 1+3 only), NODEAD 773 nodes'
CFG.GPU_NUM = 1
...
CFG.ENCODER = {
    ...
    'freeze': False,
    'lr': 1e-4,
    'ckpt_path': 'checkpoints/InputCorrectorPretrain_NODEAD_NoCrossAttn/SAN_BERNARDINO_NODEAD_30_12_12/*/InputCorrectorPretrain_NODEAD_NoCrossAttn_best_val_MAE.pt',
    'input_dim': 5,
    'd_model': 5,
    'hidden_dim': 64,
    'n_heads': 4,
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'STAEformer_5ch_rgca_tv_nodead_no_crossattn'
