"""
STAEformer 5ch + Linear Attention Denoising Encoder + Noise Augmentation.

Combo: frozen pretrained LinearAttentionDenoisingEncoder + training-time noise injection.

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/STAEformer/SAN_BERNARDINO_5ch_linear_attention_denoising_noisy.py', gpus='1')"
"""
import os
import sys
...
CFG = EasyDict()
CFG.DESCRIPTION = 'STAEformer 5ch + Linear Attention Denoising Encoder (frozen) + Noise Augmentation'
CFG.GPU_NUM = 1
...
CFG.ENCODER = {
    ...
    'source': 'pretrained',
    'freeze': True,
    'ckpt_path': 'checkpoints/LinearAttentionDenoisingPretrain/SAN_BERNARDINO_30_12_12/*/LinearAttentionDenoisingPretrain_best_val_MAE.pt',
    'input_dim': 5,
    'd_model': 5,
    'hidden_dim': 64,
    'n_heads': 4,
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'STAEformer_5ch_linear_attention_denoising_noisy'
