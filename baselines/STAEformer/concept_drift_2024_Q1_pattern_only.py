...
from basicts.runners import PatternOnlyRunner
...
CFG = EasyDict()
CFG.DESCRIPTION = "STAEformer Pattern-Only (additive centering) - 2024 Q1"
CFG.GPU_NUM = 1
CFG.RUNNER = PatternOnlyRunner
