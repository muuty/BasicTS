"""
STAEformer 5ch + Gated MLP Encoder (frozen, pretrained) + Noise Augmentation.

x_hat = x + g(x) * delta(x)

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/STAEformer/SAN_BERNARDINO_5ch_gated_mlp_noisy.py', gpus='1')"
"""
import os
import sys
...
CFG = EasyDict()
CFG.DESCRIPTION = 'STAEformer 5ch + Gated MLP Encoder (frozen) + Noise Augmentation'
CFG.GPU_NUM = 1
...
CFG.ENCODER = {
    ...
    'source': 'pretrained',
    'freeze': True,
    'ckpt_path': 'checkpoints/GatedMLP_Pretrain/SAN_BERNARDINO_30_12_12/*/GatedMLP_Pretrain_best_val_MAE.pt',
    'input_dim': 5,
    'd_model': 5,
    'hidden_dim': 64,
    'dropout': 0.1,
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'STAEformer_5ch_gated_mlp_noisy'
