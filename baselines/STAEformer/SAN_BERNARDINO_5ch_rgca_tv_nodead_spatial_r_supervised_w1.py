"""
STAEformer 5ch + InputSpilloverCorrector V3 (Spatial, Strong R Supervised r_weight=1.0).
Dataset: SAN_BERNARDINO_NODEAD (773 nodes).

Uses pretrained corrector with strong r supervision (BCE, r_weight=1.0).
Tests whether stronger supervision further improves r discrimination + denoising.

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/STAEformer/SAN_BERNARDINO_5ch_rgca_tv_nodead_spatial_r_supervised_w1.py', gpus='1')"
"""
import os
import sys
import torch
...
CFG = EasyDict()
CFG.DESCRIPTION = 'STAEformer 5ch + V3 spatial with strong r supervision (r_weight=1.0)'
CFG.GPU_NUM = 1
...
CFG.ENCODER = {
    ...
    'freeze': False,
    'lr': 1e-4,
    'ckpt_path': 'checkpoints/InputCorrectorPretrain_NODEAD_Spatial_RSupervised_W1/SAN_BERNARDINO_NODEAD_30_12_12/*/InputCorrectorPretrain_NODEAD_Spatial_RSupervised_W1_best_val_MAE.pt',
    'input_dim': 5,
    'd_model': 5,
    'hidden_dim': 64,
    'n_heads': 4,
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'STAEformer_5ch_rgca_tv_nodead_spatial_r_supervised_w1'
