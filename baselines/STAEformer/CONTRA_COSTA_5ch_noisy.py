"""
STAEformer 5ch with training-time noise augmentation for CONTRA_COSTA.
Core 2x2 factorial: E0+N1 (no encoder, noisy training).
"""
import os
import sys
...
CFG = EasyDict()
CFG.DESCRIPTION = 'STAEformer 5ch + noise augmentation for CONTRA_COSTA'
CFG.GPU_NUM = 1
