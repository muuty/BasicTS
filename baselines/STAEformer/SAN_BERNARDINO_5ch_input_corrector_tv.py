"""
STAEformer 5ch with Input Spillover Corrector — Time-Varying Correction.

Key change from v1: time_varying_correction=True
  - No mean pool: reliability, cross-attention, correction all per-timestep
  - Enables per-timestep delta (critical for dead sensor recovery)
...
Usage:
    python -c "from basicts import launch_training; launch_training('baselines/STAEformer/SAN_BERNARDINO_5ch_input_corrector_tv.py', gpus='1')"
"""
import os
import sys
