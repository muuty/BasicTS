"""
Ablation A2 Downstream: Simple MLP encoder (no temporal/spatial) + noise augmentation.
"""
import os
import sys
...
CFG = EasyDict()
CFG.DESCRIPTION = 'Ablation A2: Simple MLP encoder + noise augmentation'
CFG.GPU_NUM = 1
...
CFG.ENCODER = {
    ...
    'source': 'pretrained',
    'freeze': True,
    'ckpt_path': 'checkpoints/AblationA2_SimpleMLP/SAN_BERNARDINO_30_12_12/3cdfa7731e1b11d0c66a6a58d95b5006/AblationA2_SimpleMLP_best_val_MAE.pt',
    'input_dim': 5,
    'd_model': 5,
    'hidden_dim': 64,
    'dropout': 0.1,
...
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'STAEformer_ablation_a2_mlp'
