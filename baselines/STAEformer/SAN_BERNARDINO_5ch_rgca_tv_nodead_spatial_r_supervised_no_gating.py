"""
STAEformer 5ch + InputSpilloverCorrector V3 (Spatial, R-Supervised Pretrain, No R-Gating).
Dataset: SAN_BERNARDINO_NODEAD (773 nodes).

Ablation: Uses r-supervised pretrained corrector but disables r-gating during downstream.
Tests whether r-supervision improves representation quality even without explicit gating.

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/STAEformer/SAN_BERNARDINO_5ch_rgca_tv_nodead_spatial_r_supervised_no_gating.py', gpus='1')"
"""
import os
import sys
import torch
...
CFG = EasyDict()
CFG.DESCRIPTION = 'STAEformer 5ch + V3 spatial r-supervised pretrain, no r-gating downstream'
CFG.GPU_NUM = 1
...
CFG.ENCODER = {
    ...
    'freeze': False,
    'lr': 1e-4,
    # Reuse r-supervised pretrained weights
    'ckpt_path': 'checkpoints/InputCorrectorPretrain_NODEAD_Spatial_RSupervised/SAN_BERNARDINO_NODEAD_30_12_12/*/InputCorrectorPretrain_NODEAD_Spatial_RSupervised_best_val_MAE.pt',
    'input_dim': 5,
    'd_model': 5,
    'hidden_dim': 64,
    'n_heads': 4,
    ...
    # Key ablation: disable r-gating during downstream
    'disable_reliability': True,
}
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'STAEformer_5ch_rgca_tv_nodead_spatial_r_supervised_no_gating'
