"""
STAEformer 5ch with Denoising Encoder + Noise Augmentation.

Combines both approaches:
- Frozen pretrained DenoisingEncoder cleans input
- Training-time noise augmentation (before encoder) builds model robustness
- Encoder practices denoising noisy input; model handles residual noise

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/STAEformer/SAN_BERNARDINO_5ch_denoising_noisy.py', gpus='1')"
"""
import os
import sys
...
CFG = EasyDict()
CFG.DESCRIPTION = 'STAEformer 5ch + Denoising Encoder + Noise Augmentation'
CFG.GPU_NUM = 1
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'STAEformer_5ch_denoising_noisy'
