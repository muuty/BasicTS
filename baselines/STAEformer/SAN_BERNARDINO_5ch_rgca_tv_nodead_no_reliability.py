"""
STAEformer 5ch + InputSpilloverCorrector, Time-Varying Correction.
Dataset: SAN_BERNARDINO_NODEAD (773 nodes).
Ablation: disable_reliability=True (ungated cross-attention, r=1 always).

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/STAEformer/SAN_BERNARDINO_5ch_rgca_tv_nodead_no_reliability.py', gpus='1')"
"""
import os
import sys
import torch
...
CFG = EasyDict()
CFG.DESCRIPTION = 'Ablation: no reliability gating (r=1), NODEAD 773 nodes'
CFG.GPU_NUM = 1
...
CFG.ENCODER = {
    ...
    'freeze': False,
    'lr': 1e-4,
    'ckpt_path': 'checkpoints/InputCorrectorPretrain_NODEAD_NoReliability/SAN_BERNARDINO_NODEAD_30_12_12/*/InputCorrectorPretrain_NODEAD_NoReliability_best_val_MAE.pt',
    'input_dim': 5,
    'd_model': 5,
    'hidden_dim': 64,
    'n_heads': 4,
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'STAEformer_5ch_rgca_tv_nodead_no_reliability'
