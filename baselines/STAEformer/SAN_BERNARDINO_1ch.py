"""
STAEformer 1ch baseline: flow only as physical input, tod/dow for embeddings only.
For RQ1: comparing 1ch vs 3ch (flow+occ+speed) noise robustness.
"""
import os
import sys
...
MODEL_PARAM = {
    ...
    "steps_per_day": 288,
    "input_dim": 1,  # flow only as physical input
    "output_dim": 1,
...
CFG = EasyDict()
CFG.DESCRIPTION = 'STAEformer 1ch baseline (flow only, tod/dow embeddings)'
CFG.GPU_NUM = 1
