"""
STAEformer 5ch with Denoising Encoder + Noise Augmentation for CONTRA_COSTA.
Core 2x2 factorial: E1+N1 (frozen v1 encoder + noisy training).
"""
import os
import sys
...
CFG = EasyDict()
CFG.DESCRIPTION = 'STAEformer 5ch + Denoising Encoder + Noise Augmentation for CONTRA_COSTA'
CFG.GPU_NUM = 1
...
CFG.ENCODER = {
    ...
    'source': 'pretrained',
    'freeze': True,
    'ckpt_path': 'checkpoints/DenoisingPretrain/CONTRA_COSTA_30_12_12/*/DenoisingPretrain_best_val_MAE.pt',
    'input_dim': 5,
    'd_model': 5,
    'hidden_dim': 32,
    'temporal_layers': 4,
