"""
STAEformer 5ch + InputSpilloverCorrector V3 (Spatial-Temporal, R Supervised).
Dataset: SAN_BERNARDINO_NODEAD (773 nodes).

Uses pretrained corrector with explicit r supervision (BCE on noise_mask).
Tests whether supervised reliability improves denoising + r discrimination.

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/STAEformer/SAN_BERNARDINO_5ch_rgca_tv_nodead_spatial_r_supervised.py', gpus='1')"
"""
import os
import sys
import torch
...
CFG = EasyDict()
CFG.DESCRIPTION = 'STAEformer 5ch + V3 spatial with supervised r, NODEAD 773 nodes'
CFG.GPU_NUM = 1
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'STAEformer_5ch_rgca_tv_nodead_spatial_r_supervised'
