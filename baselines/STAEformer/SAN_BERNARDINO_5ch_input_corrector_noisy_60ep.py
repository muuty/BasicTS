"""
STAEformer 5ch with Input Spillover Corrector (60ep pretrain) + Noise Augmentation.

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/STAEformer/SAN_BERNARDINO_5ch_input_corrector_noisy_60ep.py', gpus='1')"
"""
import os
import sys
...
CFG = EasyDict()
CFG.DESCRIPTION = 'STAEformer 5ch + Input Corrector 60ep (frozen) + Noise Aug'
CFG.GPU_NUM = 1
...
CFG.ENCODER = {
    ...
    'source': 'pretrained',
    'freeze': True,
    'ckpt_path': 'checkpoints/InputCorrectorPretrain60ep/SAN_BERNARDINO_60_12_12/*/InputCorrectorPretrain60ep_best_val_MAE.pt',
    'input_dim': 5,
    'd_model': 5,
    'hidden_dim': 64,
    'n_heads': 4,
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'STAEformer_5ch_input_corrector_noisy_60ep'
