"""
STAEformer 5ch with InputSpilloverCorrectorV2 (frozen) + Noise Augmentation.

V2 encoder: memory-augmented cross-attention, trained with r supervision.

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/STAEformer/SAN_BERNARDINO_5ch_input_corrector_v2_noisy.py', gpus='1')"
"""
import os
import sys
...
CFG = EasyDict()
CFG.DESCRIPTION = 'STAEformer 5ch + InputCorrectorV2 (frozen) + Noise Aug'
CFG.GPU_NUM = 1
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'STAEformer_5ch_input_corrector_v2_noisy'
