"""
Ablation A7 Downstream: Full encoder without residual connection + noise augmentation.
"""
import os
import sys
...
CFG = EasyDict()
CFG.DESCRIPTION = 'Ablation A7: No residual connection + noise augmentation'
CFG.GPU_NUM = 1
...
CFG.ENCODER = {
    ...
    'source': 'pretrained',
    'freeze': True,
    'ckpt_path': 'checkpoints/AblationA7_NoResidual/SAN_BERNARDINO_30_12_12/4dce49649b911bd149ddfc5090a5b260/AblationA7_NoResidual_best_val_MAE.pt',
    'input_dim': 5,
    'd_model': 5,
    'hidden_dim': 64,
    'temporal_layers': 4,
...
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'STAEformer_ablation_a7_no_residual'
