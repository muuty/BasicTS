"""
STAEformer 5ch + Denoising Encoder v2 + Noise Augmentation for CONTRA_COSTA.
v2: residual connection + hidden_dim=64 + stronger noise pretraining.
Encoder + noise augmentation (E2+N1).

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/STAEformer/CONTRA_COSTA_5ch_denoising_v2_noisy.py', gpus='1')"
"""
import os
import sys
...
CFG = EasyDict()
CFG.DESCRIPTION = 'STAEformer 5ch + Denoising Encoder v2 (residual+h64) + Noise Augmentation for CONTRA_COSTA'
CFG.GPU_NUM = 1
...
CFG.ENCODER = {
    ...
    'source': 'pretrained',
    'freeze': True,
    'ckpt_path': 'checkpoints/DenoisingPretrainV2/CONTRA_COSTA_30_12_12/*/DenoisingPretrainV2_best_val_MAE.pt',
    'input_dim': 5,
    'd_model': 5,
    'hidden_dim': 64,
    'temporal_layers': 4,
