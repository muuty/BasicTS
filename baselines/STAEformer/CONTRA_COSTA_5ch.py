"""
STAEformer 5ch baseline for CONTRA_COSTA.
Uses all 5 channels: flow(0), occ(1), speed(2) as physical input + tod(3), dow(4) as embeddings.
"""
import os
import sys
...
CFG = EasyDict()
CFG.DESCRIPTION = 'STAEformer 5ch baseline for CONTRA_COSTA'
CFG.GPU_NUM = 1
