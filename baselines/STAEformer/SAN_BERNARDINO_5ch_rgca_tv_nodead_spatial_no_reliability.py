"""
STAEformer 5ch + InputSpilloverCorrector V3 (Spatial-Temporal, NO Reliability).
Dataset: SAN_BERNARDINO_NODEAD (773 nodes).

Ablation: disable_reliability=True — correction applied unconditionally (no r-gating).
Tests whether the learned reliability score r contributes to denoising.

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/STAEformer/SAN_BERNARDINO_5ch_rgca_tv_nodead_spatial_no_reliability.py', gpus='1')"
"""
import os
import sys
import torch
...
CFG = EasyDict()
CFG.DESCRIPTION = 'STAEformer 5ch + V3 spatial NO reliability, NODEAD 773 nodes'
CFG.GPU_NUM = 1
...
CFG.ENCODER = {
    ...
    'freeze': False,
    'lr': 1e-4,
    'ckpt_path': 'checkpoints/InputCorrectorPretrain_NODEAD_Spatial_NoReliability/SAN_BERNARDINO_NODEAD_30_12_12/*/InputCorrectorPretrain_NODEAD_Spatial_NoReliability_best_val_MAE.pt',
    'input_dim': 5,
    'd_model': 5,
    'hidden_dim': 64,
    'n_heads': 4,
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'STAEformer_5ch_rgca_tv_nodead_spatial_no_reliability'
