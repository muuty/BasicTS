"""
Ablation A3 Downstream: Temporal-only encoder (no spatial GraphConv) + noise augmentation.
"""
import os
import sys
...
CFG = EasyDict()
CFG.DESCRIPTION = 'Ablation A3: Temporal-only encoder + noise augmentation'
CFG.GPU_NUM = 1
...
CFG.ENCODER = {
    ...
    'source': 'pretrained',
    'freeze': True,
    'ckpt_path': 'checkpoints/AblationA3_TemporalOnly/SAN_BERNARDINO_30_12_12/7cd0ccc56b88c6266ab71ff5cd84a770/AblationA3_TemporalOnly_best_val_MAE.pt',
    'input_dim': 5,
    'd_model': 5,
    'hidden_dim': 64,
    'temporal_layers': 4,
...
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'STAEformer_ablation_a3_temporal_only'
