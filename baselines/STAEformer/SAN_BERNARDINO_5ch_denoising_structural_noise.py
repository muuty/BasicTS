"""
STAEformer 5ch + Denoising Encoder trained with STRUCTURAL noise only (stuck/dead).
For RQ4: Cross-noise generalization - evaluate against all noise types including unseen (gaussian, bias, drift).
"""
import os
import sys
...
CFG = EasyDict()
CFG.DESCRIPTION = 'STAEformer 5ch + Denoising Encoder (structural noise: stuck/dead)'
CFG.GPU_NUM = 1
...
CFG.ENCODER = {
    ...
    'source': 'pretrained',
    'freeze': True,
    'ckpt_path': 'checkpoints/DenoisingPretrain_StructuralNoise/SAN_BERNARDINO_30_12_12/*/DenoisingPretrain_StructuralNoise_best_val_MAE.pt',
    'input_dim': 5,
    'd_model': 5,
    'hidden_dim': 32,
    'temporal_layers': 4,
...
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'STAEformer_5ch_denoising_structural_noise'
