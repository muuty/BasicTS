"""
STAEformer 5ch + Denoising Encoder v2 for CONTRA_COSTA.
v2: residual connection + hidden_dim=64 + stronger noise pretraining.
Encoder only, no noise augmentation (E2+N0).

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/STAEformer/CONTRA_COSTA_5ch_denoising_v2.py', gpus='1')"
"""
import os
import sys
...
CFG = EasyDict()
CFG.DESCRIPTION = 'STAEformer 5ch + Denoising Encoder v2 (residual+h64) for CONTRA_COSTA'
CFG.GPU_NUM = 1
...
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'STAEformer_5ch_denoising_v2'
