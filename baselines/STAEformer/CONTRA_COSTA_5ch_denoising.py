"""
STAEformer 5ch + Denoising Encoder for CONTRA_COSTA.
Same architecture as SAN_BERNARDINO variant, adapted for 773 nodes.
"""
import os
import sys
...
CFG = EasyDict()
CFG.DESCRIPTION = 'STAEformer 5ch + Denoising Encoder for CONTRA_COSTA'
CFG.GPU_NUM = 1
