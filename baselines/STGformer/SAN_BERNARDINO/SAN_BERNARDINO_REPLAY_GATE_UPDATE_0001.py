...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    'checkpoints',
    MODEL_ARCH.__name__,
    '_'.join([DATA_NAME, "REPLAY_GATE_UPDATE_0001", str(CFG.TRAIN.NUM_EPOCHS), str(INPUT_LEN), str(OUTPUT_LEN)])
)
...
# Early stopping
CFG.TRAIN.EARLY_STOPPING_PATIENCE = 40
...
CFG.EXPERIENCE_REPLAY.BATCH_SIZE = 16  # Batch size for replay updates
CFG.EXPERIENCE_REPLAY.UPDATE_TARGET = 'gate'  # Update target: 'gate' (only gate parameters) or 'all' (all model parameters)
CFG.EXPERIENCE_REPLAY.LR = 0.0001  # Learning rate for replay optimizer


############################## Gating Module Configuration ##############################
# Gating module configuration (required for experience replay)
CFG.GATING_MODULE = True  # Enable gating module
