...
# Server는 토큰 간 attention이므로 identity graph 사용
server_num_tokens = NUM_CLIENTS * NUM_TOKENS
server_identity = torch.eye(server_num_tokens)
server_supports = [server_identity]

SERVER_SPATIAL_PARAMS = {
    "num_nodes": server_num_tokens,
    "in_steps": INPUT_LEN,
    "adaptive_embedding_dim": ADAPTIVE_EMBEDDING_DIM,
    "model_dim": MODEL_DIM,
    "mlp_ratio": MLP_RATIO,
...
CFG = EasyDict()
CFG.DESCRIPTION = 'STGformer Hierarchical Split Learning'
CFG.GPU_NUM = 1
