...
from contrastive.contrastive_loss import PredictionGuidedBidirectionalLoss
...
CFG.CONTRASTIVE_LOSS = PredictionGuidedBidirectionalLoss(
    adj=adj_mx,
)
CFG.CONTRASTIVE_LOSS_WEIGHT = 0.08
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    'checkpoints',
    MODEL_ARCH.__name__,
    '_'.join([DATA_NAME, "PRED",str(CFG.CONTRASTIVE_LOSS_WEIGHT), str(CFG.TRAIN.NUM_EPOCHS), str(INPUT_LEN), str(OUTPUT_LEN)])
)
