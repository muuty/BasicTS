...
CFG.CONTRASTIVE_LOSS = MinimalAntiSmoothingLoss(
    adj=adj_mx,
    margin=0.5,
    eps=1e-6,
    alpha=2.0,
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    'checkpoints',
    MODEL_ARCH.__name__,
    '_'.join([DATA_NAME, "CL","a",str(CFG.CONTRASTIVE_LOSS.alpha), "b",str(CFG.CONTRASTIVE_LOSS.beta), str(CFG.TRAIN.NUM_EPOCHS), str(INPUT_LEN), str(OUTPUT_LEN)])
)
