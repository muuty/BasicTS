"""
STGCN with Denoising Encoder + Noise Augmentation.
...
Usage:
    python -c "from basicts import launch_training; launch_training('baselines/STGCN/SAN_BERNARDINO_denoising_noisy.py', gpus='1')"
"""
import os
import sys
import torch
...
CFG = EasyDict()
CFG.DESCRIPTION = 'STGCN + Denoising Encoder + Noise Augmentation'
CFG.GPU_NUM = 1
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'STGCN_denoising_noisy'
