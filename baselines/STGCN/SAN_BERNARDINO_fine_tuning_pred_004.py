...
from contrastive.contrastive_loss import PredictionGuidedRepelLoss
...
CFG.CONTRASTIVE_LOSS = PredictionGuidedRepelLoss(
    adj=adj_mx,
)
CFG.CONTRASTIVE_LOSS_WEIGHT = 0.0005
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    'checkpoints',  
    MODEL_ARCH.__name__,
    '_'.join([DATA_NAME, "FINETUNE_V2",str(CFG.CONTRASTIVE_LOSS_WEIGHT), str(CFG.TRAIN.NUM_EPOCHS), str(INPUT_LEN), str(OUTPUT_LEN)])
)
...
CFG.TRAIN.FINETUNE_FROM = 'checkpoints/STGCNChebGraphConv/xtraffic/SAN_BERNARDINO_100_12_12/1a8370b513fd6ae305fa404dd0589d21/STGCNChebGraphConv_best_val_MAE.pt'
CFG.TRAIN.STRICT_LOAD = True
CFG.TRAIN.FREEZE_LAYERS = ['st_blocks.0']
