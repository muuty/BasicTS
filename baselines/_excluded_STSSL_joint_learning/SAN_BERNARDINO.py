"""
ST-SSL Configuration for SAN_BERNARDINO Dataset.
...
from baselines._excluded_STSSL_joint_learning.arch import STSSL
from baselines._excluded_STSSL_joint_learning.runner import STSSLRunner
...
# Model architecture
MODEL_ARCH = STSSL
NUM_NODES = 893  # SAN_BERNARDINO has 893 nodes

MODEL_PARAM = {
    "num_nodes": NUM_NODES,
    "in_steps": INPUT_LEN,
    "out_steps": OUTPUT_LEN,
    "input_dim": 1,  # Only use speed feature for ST encoder
    "output_dim": 1,
    "d_model": 64,
    "dropout": 0.1,
...
CFG = EasyDict()
CFG.DESCRIPTION = 'ST-SSL model for SAN_BERNARDINO dataset'
CFG.GPU_NUM = 1
...
CFG.MODEL.FORWARD_FEATURES = [0]  # Only use speed feature
