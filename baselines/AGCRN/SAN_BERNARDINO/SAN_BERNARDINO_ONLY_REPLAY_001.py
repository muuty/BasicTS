...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    'checkpoints',
    MODEL_ARCH.__name__,
    '_'.join([DATA_NAME, "ONLY_REPLAY_001", str(CFG.TRAIN.NUM_EPOCHS), str(INPUT_LEN), str(OUTPUT_LEN)])
)
...
CFG.EXPERIENCE_REPLAY.CAPACITY_RATIO = 0.1 # Maximum number of samples in replay buffer
CFG.EXPERIENCE_REPLAY.SEED = 42  # Random seed for replay buffer (None = no fixed seed)
CFG.EXPERIENCE_REPLAY.BATCH_SIZE = 64
CFG.EXPERIENCE_REPLAY.UPDATE_TARGET = 'all'
CFG.EXPERIENCE_REPLAY.WEIGHT = 0.1  # λ: replay loss 비중
