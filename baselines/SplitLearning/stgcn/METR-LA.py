...
from baselines.STGCN.arch.spatial import STGCNServerSTBlock
...
# Server Spatial 파라미터 (STGCNServerSTBlock 기반: T-G-T-N-D)
SERVER_SPATIAL_PARAMS = {
    "Kt": KT,
    "Ks": KS,
    "num_nodes": NUM_NODES,
    "in_channels": BLOCKS[2][-1],  # encoder 출력 feature dim
    "mid_channels": BLOCKS[1][1],  # 16 (기본 STGCN 중간 채널)
    "act_func": ACT_FUNC,
    "graph_conv_type": GRAPH_CONV_TYPE,
    "adj_matrix": adj_mx,
    "bias": BIAS,
    "droprate": DROPRATE,
    # split에서 시간축 길이 유지(안전)
    "preserve_time": True,
}
...
MODEL_PARAM = {
    ...
    "spatial_cls": STGCNServerSTBlock,
