...
# v3c: curriculum augmentation
# Start with low corruption rates, gradually increase to full range
# Epoch 0: max_rate=0.1, Epoch 30: max_rate=0.5
MODEL_PARAM = {
    "input_dim": 8,
    "hidden_dim": 64,
    "output_dim": 32,
    ...
    "rate_range": (0.01, 0.1),   # initial range (overridden by curriculum)
    "curriculum": {
        "min_rate": 0.01,
        "max_rate_start": 0.1,
        "max_rate_end": 0.5,
...
CFG = EasyDict()
CFG.DESCRIPTION = 'MICL v3c pretrain: curriculum augmentation (0.01-0.1 -> 0.01-0.5)'
CFG.GPU_NUM = 1
