"""
Denoising Encoder Pre-training for CONTRA_COSTA.
Same architecture as SAN_BERNARDINO, adapted for 773 nodes.
"""
import os
import sys
...
CFG = EasyDict()
CFG.DESCRIPTION = 'Denoising Encoder Pre-training for CONTRA_COSTA'
CFG.GPU_NUM = 1
