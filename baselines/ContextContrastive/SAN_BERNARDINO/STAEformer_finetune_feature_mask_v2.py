"""
Ablation Study: Fine-tuning with Feature Masking Pre-trained Encoder (v2)

Uses the unified RepresentationLearningRunner with proper checkpoint save/load.

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/ContextContrastive/SAN_BERNARDINO/STAEformer_finetune_feature_mask_v2.py', gpus='0')"
"""
import os
import sys
...
CFG = EasyDict()
CFG.DESCRIPTION = 'Feature Masking Fine-tune (Unified Runner v2)'
CFG.GPU_NUM = 1
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'STAEformer_FeatureMask_v2'
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    'checkpoints',
    'ContextContrastive_finetune_feature_mask_v2_3mo',
