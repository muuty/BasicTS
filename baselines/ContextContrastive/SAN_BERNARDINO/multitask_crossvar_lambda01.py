"""MultiTask STAEformer: Forecasting + Cross-Variable Reconstruction (lambda=0.1)
...
Usage:
    python -c "from basicts import launch_training; launch_training('baselines/ContextContrastive/SAN_BERNARDINO/multitask_crossvar_lambda01.py', gpus='0')"
"""
import os, sys
