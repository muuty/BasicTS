"""
Ablation Study: Fine-tuning with Temporal Masking Pre-trained Encoder

Evaluates the encoder pre-trained with temporal masking augmentation
...
Usage:
    python -c "from basicts import launch_training; launch_training('baselines/ContextContrastive/SAN_BERNARDINO/STAEformer_finetune_temporal_mask.py', gpus='0')"
"""
import os
import sys
...
############################## Encoder Configuration (TEMPORAL MASKING) ##############################
ENCODER = {
    'type': 'TransformerEncoder',
    'source': 'pretrained',
    'ckpt_path': f'checkpoints/ContextContrastive_temporal_mask_3mo/xtraffic_SAN_BERNARDINO_30_{INPUT_LEN}_{OUTPUT_LEN}/*/Pretrain_TemporalMask_best_val_MAE.pt',
    'input_dim': 3,
    'd_model': D_MODEL,
...
CFG = EasyDict()
CFG.DESCRIPTION = 'Ablation: Fine-tune with Temporal Masking Pre-trained Encoder'
CFG.GPU_NUM = 1
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'STAEformer_TemporalMask'
