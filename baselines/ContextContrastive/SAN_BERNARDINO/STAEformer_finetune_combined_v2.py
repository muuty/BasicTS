"""
Fine-tuning with Combined v2 Pre-trained Encoder (Feature 20% + Temporal 10%)

Prerequisites:
    Run pre-training first: pretrain_combined_v2.py
"""
import os
import sys
...
ENCODER = {
    ...
    'source': 'pretrained',
    'ckpt_path': f'checkpoints/ContextContrastive_combined_v2_3mo/xtraffic_SAN_BERNARDINO_100_{INPUT_LEN}_{OUTPUT_LEN}/*/Pretrain_Combined_v2_best_val_MAE.pt',
    'input_dim': 3,
    'd_model': D_MODEL,
...
CFG = EasyDict()
CFG.DESCRIPTION = 'Fine-tune with Combined v2 (Feature 20% + Temporal 10%)'
CFG.GPU_NUM = 1
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'STAEformer_Combined_v2'
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    'checkpoints',
    'ContextContrastive_finetune_combined_v2_3mo',
