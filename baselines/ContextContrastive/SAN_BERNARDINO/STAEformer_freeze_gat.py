"""
Ablation Study: Frozen Encoder with GAT Pre-trained

Evaluates the encoder pre-trained with GAT - FROZEN (no fine-tuning).
...
Usage:
    python -c "from basicts import launch_training; launch_training('baselines/ContextContrastive/SAN_BERNARDINO/STAEformer_freeze_gat.py', gpus='0')"
"""
import os
import sys
...
############################## Encoder Configuration (GAT - FROZEN) ##############################
ENCODER = {
    'type': 'TransformerEncoder',
    'source': 'pretrained',
    'ckpt_path': f'checkpoints/ContextContrastive_GAT_pretrain_3mo/xtraffic_SAN_BERNARDINO_30_{INPUT_LEN}_{OUTPUT_LEN}/*/GAT_Pretrain_*.pt',
    'input_dim': 3,
    'd_model': D_MODEL,
...
CFG = EasyDict()
CFG.DESCRIPTION = 'Ablation: Frozen Encoder with GAT'
CFG.GPU_NUM = 1
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'STAEformer_GAT_Freeze'
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    'checkpoints',
    'ContextContrastive_freeze_GAT_3mo',
