"""
Linear Attention Denoising Encoder Pre-training with clean passthrough.
30% of batches are clean (no noise) to learn identity mapping.
"""
import os
import sys
...
CFG = EasyDict()
CFG.DESCRIPTION = 'Linear Attention Denoising Encoder with 30% clean passthrough'
CFG.GPU_NUM = 1
...
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'LinearAttnPretrain_WithClean'
