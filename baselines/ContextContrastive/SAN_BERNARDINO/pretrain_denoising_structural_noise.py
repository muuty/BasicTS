"""
Cross-noise generalization: Train with STRUCTURAL noise only (stuck, dead).
Test generalization to unseen additive noise (gaussian, bias, drift).
...
MODEL_PARAM = {
    ...
    "noise_types": ["stuck", "dead"],  # structural noise only
}
NUM_EPOCHS = 30

CFG = EasyDict()
CFG.DESCRIPTION = 'Denoising pretrain: structural noise only (stuck/dead)'
CFG.GPU_NUM = 1
...
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'DenoisingPretrain_StructuralNoise'
