"""STAEformer with FROZEN Reconstruction-Pretrained Encoder (Spatial 90%)
...
Usage:
    python -c "from basicts import launch_training; launch_training('baselines/ContextContrastive/SAN_BERNARDINO/STAEformer_freeze_reconstruction_spatial90.py', gpus='0')"
"""
import os, sys
...
CFG_ENCODER = {
    ...
    'source': 'pretrained',
    'freeze': True,
    'ckpt_path': 'checkpoints/ContextContrastive_reconstruction_spatial90_3mo/xtraffic_SAN_BERNARDINO_12_12/*/ContextContrastive_reconstruction_spatial90_3mo_best_val*MAE.pt',
    'input_dim': 3,
    'd_model': D_MODEL,
    'num_layers': 2,
    'nhead': 4,
...
CFG = EasyDict()
CFG.DESCRIPTION = 'STAEformer + FROZEN Reconstruction Encoder (Spatial 90%, MAE-style)'
CFG.GPU_NUM = 1
...
CFG.MODEL = EasyDict({
    'NAME': 'ContextContrastive_freeze_reconstruction_spatial90_3mo',
    'ARCH': STAEformer,
    'PARAM': MODEL_PARAM,
