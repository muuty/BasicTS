"""
Reconstruction-Only Pre-training (MAE-style) - Spatial 10%

No contrastive loss - only reconstruction loss.
Masks 10% of nodes and reconstructs them.

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/ContextContrastive/SAN_BERNARDINO/pretrain_reconstruction_spatial10.py', gpus='0')"
"""
import os
import sys
