"""
Ablation A7: Full model without residual connection.
Same as v2 (hidden=64, strong noise) but residual_connection=False.
Tests whether learning correction term (vs full reconstruction) matters.
"""
import os
import sys
...
MODEL_PARAM = {
    ...
    "residual_connection": False,  # <-- No residual
}
NUM_EPOCHS = 30

CFG = EasyDict()
CFG.DESCRIPTION = 'Ablation A7: No residual connection (full reconstruction)'
CFG.GPU_NUM = 1
...
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'AblationA7_NoResidual'
