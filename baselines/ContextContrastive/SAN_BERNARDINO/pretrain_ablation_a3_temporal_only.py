"""
Ablation A3: Temporal-only encoder (no GraphConv spatial layers).
Tests whether spatial consistency checking contributes to denoising.
"""
import os
import sys
...
MODEL_PARAM = {
    ...
    "hidden_dim": 64,
    "temporal_layers": 4,
    "spatial_layers": 0,       # <-- No spatial layers
    "k_neighbors": 10,
    "dropout": 0.1,
...
CFG = EasyDict()
CFG.DESCRIPTION = 'Ablation A3: Temporal-only (no spatial graph conv)'
CFG.GPU_NUM = 1
...
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'AblationA3_TemporalOnly'
