"""
Input Spillover Corrector Pre-training for SAN_BERNARDINO.

Denoising pre-training with reliability-gated cross-attention encoder.
Temporal linear attention + spatial reliability-gated cross-attention.

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/ContextContrastive/SAN_BERNARDINO/pretrain_input_corrector.py', gpus='1')"
"""
import os
import sys
...
CFG = EasyDict()
CFG.DESCRIPTION = 'InputSpilloverCorrector: reliability-gated cross-attention denoising'
CFG.GPU_NUM = 1
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'InputCorrectorPretrain'
