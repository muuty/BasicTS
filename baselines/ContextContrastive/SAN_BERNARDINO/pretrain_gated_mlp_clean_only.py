"""
Pretrain: GatedMLP Encoder - Clean Only (identity autoencoder baseline).
...
from ..arch.gated_mlp_encoder import GatedMLPPretrainModel
...
MODEL_ARCH = GatedMLPPretrainModel
NUM_NODES = 893
...
CFG = EasyDict()
CFG.DESCRIPTION = 'Pretrain: GatedMLP Encoder - Clean Only (identity baseline)'
CFG.GPU_NUM = 1
...
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'GatedMLP_Pretrain_CleanOnly'
