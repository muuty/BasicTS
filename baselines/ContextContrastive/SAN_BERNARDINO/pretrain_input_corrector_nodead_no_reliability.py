"""
Input Spillover Corrector Pre-training for SAN_BERNARDINO_NODEAD (773 nodes).
Ablation: disable_reliability=True (ungated cross-attention, r=1 for all nodes).

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/ContextContrastive/SAN_BERNARDINO/pretrain_input_corrector_nodead_no_reliability.py', gpus='1')"
"""
import os
import sys
...
CFG = EasyDict()
CFG.DESCRIPTION = 'InputSpilloverCorrector pretrain NODEAD - ablation: no reliability gating'
CFG.GPU_NUM = 1
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'InputCorrectorPretrain_NODEAD_NoReliability'
