"""
Ablation Study: Feature Masking Only Pre-training

Tests the effect of feature masking augmentation for contrastive pre-training.
Masks random feature channels to force the model to learn cross-feature patterns.

For traffic data, features are: flow, time_of_day, day_of_week
...
# Augmentation: FEATURE MASKING ONLY
# Higher mask ratio since we only have 3 features
AUGMENTATION_CONFIG = {
    'feature_masking': {'mask_ratio': 0.3},  # ~1 out of 3 features masked
}
...
CFG = EasyDict()
CFG.DESCRIPTION = 'Ablation: Feature Masking Only Pre-training'
CFG.GPU_NUM = 1
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'Pretrain_FeatureMask'
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    'checkpoints',
    'ContextContrastive_feature_mask_3mo',
