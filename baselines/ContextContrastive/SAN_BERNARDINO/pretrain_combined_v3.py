"""
Combined Augmentation v3: Feature Masking 30% + Gaussian Noise 5%

Feature masking (best single augmentation) + noise for robustness.

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/ContextContrastive/SAN_BERNARDINO/pretrain_combined_v3.py', gpus='0')"
"""
import os
import sys
...
# Augmentation: COMBINED v3 (Feature 30% + Noise 5%)
AUGMENTATION_CONFIG = {
...
CFG = EasyDict()
CFG.DESCRIPTION = 'Combined Augmentation v3: Feature 30% + Noise 5%'
CFG.GPU_NUM = 1
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'Pretrain_Combined_v3'
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    'checkpoints',
    'ContextContrastive_combined_v3_3mo',
