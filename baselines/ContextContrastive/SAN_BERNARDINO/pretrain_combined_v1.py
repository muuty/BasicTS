"""
Combined Augmentation v1: Feature Masking 30% + Temporal Masking 15%

Combines the two best performing augmentation strategies.

Hypothesis:
    - Feature masking: learns cross-modal relationships (flow ↔ tod/dow)
    - Temporal masking: learns temporal continuity
    - Combined: should capture both patterns

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/ContextContrastive/SAN_BERNARDINO/pretrain_combined_v1.py', gpus='0')"
"""
import os
import sys
...
# Augmentation: COMBINED (Feature 30% + Temporal 15%)
AUGMENTATION_CONFIG = {
...
CFG = EasyDict()
CFG.DESCRIPTION = 'Combined Augmentation v1: Feature 30% + Temporal 15%'
CFG.GPU_NUM = 1
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'Pretrain_Combined_v1'
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    'checkpoints',
    'ContextContrastive_combined_v1_3mo',
