"""
Reconstruction-Only Pre-training (MAE-style) - Spatial 90%

No contrastive loss - only reconstruction loss.
Masks 90% of nodes and reconstructs them.

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/ContextContrastive/SAN_BERNARDINO/pretrain_reconstruction_spatial90.py', gpus='0')"
"""
import os
import sys
