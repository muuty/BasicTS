"""Q2 Ablation: Downstream with Contrastive-Only Pretrained Encoder (5feat)

Tests whether contrastive loss alone produces useful representations.
Encoder pretrained with: contrastive_weight=1, reconstruction_weight=0

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/ContextContrastive/SAN_BERNARDINO/STAEformer_freeze_5feat_contrastive_only_downstream.py', gpus='0')"
"""
import os, sys
...
CFG = EasyDict()
CFG.DESCRIPTION = 'Q2 Ablation: Contrastive-Only Pretrained -> Downstream (5feat)'
CFG.GPU_NUM = 1
...
CFG.MODEL = EasyDict({
    'NAME': 'STAEformer_5feat_contrastive_only_downstream_3mo',
    'ARCH': STAEformer,
    'PARAM': MODEL_PARAM,
