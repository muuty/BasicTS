"""Residual Correction with Raw Input (Ablation) - MSE Loss

Same as residual_raw_ablation.py but with MSE loss.

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/ContextContrastive/SAN_BERNARDINO/residual_raw_ablation_mse.py', gpus='0')"
"""
import os, sys
...
CFG = EasyDict()
CFG.DESCRIPTION = 'Residual Correction with Raw Input (Ablation) - MSE Loss'
CFG.GPU_NUM = 1
...
CFG.MODEL = EasyDict({
    'NAME': 'Residual_raw_ablation_mse_3mo',
    'ARCH': ResidualMLP,
    'PARAM': MODEL_PARAM,
