"""
Baseline: STAEformer for SAN_BERNARDINO with Incident Evaluation

Standard STAEformer without pre-trained encoder, but with incident-specific evaluation.
This serves as the comparison baseline for the Context-Contrastive approach.

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/ContextContrastive/SAN_BERNARDINO/baseline.py', gpus='0')"
"""
import os
import sys
...
CFG = EasyDict()
CFG.DESCRIPTION = 'Baseline: STAEformer with Incident Evaluation'
CFG.GPU_NUM = 1
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'STAEformer_Baseline'
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    'checkpoints',
    'ContextContrastive_baseline_3mo',
