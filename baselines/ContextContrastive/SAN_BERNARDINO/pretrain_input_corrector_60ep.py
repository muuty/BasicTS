"""
Input Spillover Corrector Pre-training (60 epochs) for SAN_BERNARDINO.

Extended pretraining for better convergence (30ep loss 6.81→3.84, still improving).

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/ContextContrastive/SAN_BERNARDINO/pretrain_input_corrector_60ep.py', gpus='1')"
"""
import os
import sys
...
CFG = EasyDict()
CFG.DESCRIPTION = 'InputSpilloverCorrector 60ep: extended pretraining for better convergence'
CFG.GPU_NUM = 1
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'InputCorrectorPretrain60ep'
