"""
Ablation Study: Temporal Masking Only Pre-training

Tests the effect of temporal masking augmentation for contrastive pre-training.
Masks random time steps to force the model to learn temporal patterns.
...
# Augmentation: TEMPORAL MASKING ONLY
AUGMENTATION_CONFIG = {
...
CFG = EasyDict()
CFG.DESCRIPTION = 'Ablation: Temporal Masking Only Pre-training'
CFG.GPU_NUM = 1
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'Pretrain_TemporalMask'
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    'checkpoints',
    'ContextContrastive_temporal_mask_3mo',
