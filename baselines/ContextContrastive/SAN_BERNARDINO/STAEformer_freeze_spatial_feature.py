"""
STAEformer with FROZEN Spatial+Feature Pretrained Encoder

Uses encoder pretrained with node masking (spatial) + feature masking.

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/ContextContrastive/SAN_BERNARDINO/STAEformer_freeze_spatial_feature.py', gpus='0')"
"""
import os
import sys
...
from ..runner import RepresentationLearningRunner
...
CFG_ENCODER = {
    ...
    'source': 'pretrained',
    'freeze': True,  # FROZEN
    'ckpt_path': 'checkpoints/ContextContrastive_spatial_feature_3mo/xtraffic_SAN_BERNARDINO_12_12/*/ContextContrastive_spatial_feature_3mo_best_val*MAE.pt',
...
CFG = EasyDict()
CFG.DESCRIPTION = 'STAEformer + FROZEN Spatial+Feature Pretrained Encoder'
CFG.GPU_NUM = 1
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'ContextContrastive_freeze_spatial_feature_3mo'
