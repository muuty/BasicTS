"""Q2 Ablation: Downstream with Reconstruction-Only Pretrained Encoder (5feat)

Tests whether reconstruction loss alone produces useful representations.
Encoder pretrained with: contrastive_weight=0, reconstruction_weight=1

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/ContextContrastive/SAN_BERNARDINO/STAEformer_freeze_5feat_recon_only_downstream.py', gpus='0')"
"""
import os, sys
...
CFG_ENCODER = {
    ...
    'source': 'pretrained',
    'freeze': True,
    'ckpt_path': 'checkpoints/DisentangledTemporal_5feat_recon_only_3mo/xtraffic_SAN_BERNARDINO_12_12/*/DisentangledTemporal_5feat_recon_only_3mo_best_val*MAE.pt',
    'input_dim': 5,
    'd_model': D_MODEL,
    'num_layers': 2,
    'nhead': 4,
...
CFG = EasyDict()
CFG.DESCRIPTION = 'Q2 Ablation: Recon-Only Pretrained -> Downstream (5feat)'
CFG.GPU_NUM = 1
...
CFG.MODEL = EasyDict({
    'NAME': 'STAEformer_5feat_recon_only_downstream_3mo',
    'ARCH': STAEformer,
    'PARAM': MODEL_PARAM,
