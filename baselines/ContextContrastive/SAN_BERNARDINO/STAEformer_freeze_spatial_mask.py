"""
Ablation Study: Frozen Encoder with Spatial Masking 15% Pre-trained

Evaluates the encoder pre-trained with 15% spatial masking - FROZEN (no fine-tuning).
...
Usage:
    python -c "from basicts import launch_training; launch_training('baselines/ContextContrastive/SAN_BERNARDINO/STAEformer_freeze_spatial_mask.py', gpus='0')"
"""
import os
import sys
...
CFG = EasyDict()
CFG.DESCRIPTION = 'Ablation: Frozen Encoder with Spatial Masking 15%'
CFG.GPU_NUM = 1
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'STAEformer_SpatialMask_Freeze'
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    'checkpoints',
    'ContextContrastive_freeze_spatial_mask_3mo',
