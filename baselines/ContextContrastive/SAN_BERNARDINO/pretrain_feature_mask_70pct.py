"""Feature Masking 70% Pre-training"""
import os, sys
...
AUGMENTATION_CONFIG = {'feature_masking': {'mask_ratio': MASK_RATIO}}
...
CFG = EasyDict()
CFG.DESCRIPTION = f'Contrastive Pre-training: Feature Masking {int(MASK_RATIO*100)}%'
CFG.GPU_NUM = 1
...
CFG.MODEL = EasyDict({'NAME': f'ContextContrastive_feature_mask{int(MASK_RATIO*100)}pct_3mo', 'ARCH': ConfigurablePretrainModel, 'PARAM': MODEL_PARAM, 'FORWARD_FEATURES': [0, 3, 4], 'TARGET_FEATURES': [0]})
