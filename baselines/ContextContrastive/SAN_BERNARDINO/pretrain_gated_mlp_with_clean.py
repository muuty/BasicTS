"""
Pretrain: GatedMLP Encoder with clean passthrough training.
...
CFG = EasyDict()
CFG.DESCRIPTION = 'Pretrain: GatedMLP Encoder with 30% clean passthrough'
CFG.GPU_NUM = 1
...
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'GatedMLP_Pretrain_WithClean'
