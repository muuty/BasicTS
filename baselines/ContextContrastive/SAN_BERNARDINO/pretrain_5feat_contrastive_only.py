"""Q2 Ablation: Pretrain with Contrastive Loss ONLY (5feat)

contrastive_weight=1, reconstruction_weight=0

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/ContextContrastive/SAN_BERNARDINO/pretrain_5feat_contrastive_only.py', gpus='0')"
"""
import os, sys
...
MODEL_PARAM = {
    ...
    'reconstruction_weight': 0.0,  # OFF
}

CFG = EasyDict()
CFG.DESCRIPTION = 'Q2 Ablation: Contrastive Only Pretrain (5feat)'
CFG.GPU_NUM = 1
CFG.RUNNER = DisentangledTemporalRunner
CFG.PRETRAIN = {'contrastive_weight': 1.0, 'reconstruction_weight': 0.0}
...
CFG.MODEL = EasyDict({
    'NAME': 'DisentangledTemporal_5feat_contrastive_only_3mo',
    'ARCH': DisentangledTemporalModel,
    'PARAM': MODEL_PARAM,
