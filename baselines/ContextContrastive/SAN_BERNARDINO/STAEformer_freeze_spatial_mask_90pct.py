"""STAEformer with FROZEN Spatial Masking 90% Pretrained Encoder"""
import os, sys
...
CFG_ENCODER = {
    ...
    'ckpt_path': 'checkpoints/ContextContrastive_spatial_mask90pct_3mo/xtraffic_SAN_BERNARDINO_12_12/*/ContextContrastive_spatial_mask90pct_3mo_best_val*MAE.pt',
...
CFG = EasyDict()
CFG.DESCRIPTION = 'STAEformer + FROZEN Spatial Mask 90% Encoder'
CFG.GPU_NUM = 1
...
CFG.MODEL = EasyDict({'NAME': 'ContextContrastive_freeze_spatial_mask90pct_3mo', 'ARCH': STAEformer, 'PARAM': MODEL_PARAM, 'FORWARD_FEATURES': [0, 3, 4], 'TARGET_FEATURES': [0]})
