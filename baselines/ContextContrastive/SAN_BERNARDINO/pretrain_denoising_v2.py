"""
Improved Denoising Encoder Pre-training (v2).
...
Usage:
    python -c "from basicts import launch_training; launch_training('baselines/ContextContrastive/SAN_BERNARDINO/pretrain_denoising_v2.py', gpus='1')"
"""
import os
import sys
...
CFG = EasyDict()
CFG.DESCRIPTION = 'Denoising Encoder v2: residual + stronger noise + hidden=64'
CFG.GPU_NUM = 1
