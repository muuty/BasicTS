"""
Linear Attention Encoder - Clean Only (identity autoencoder baseline).
No noise injection. Encoder learns to reconstruct clean input perfectly.
"""
import os
import sys
...
from ..arch.linear_attention_pretrain_model import LinearAttentionPretrainModel
...
MODEL_ARCH = LinearAttentionPretrainModel
NUM_NODES = 893
...
MODEL_PARAM = {
    ...
    "clean_prob": 1.0,  # 100% clean = identity autoencoder
}
NUM_EPOCHS = 30

CFG = EasyDict()
CFG.DESCRIPTION = 'Linear Attention Encoder - Clean Only (identity baseline)'
CFG.GPU_NUM = 1
...
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'LinearAttnPretrain_CleanOnly'
