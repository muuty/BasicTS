"""
Ablation Study: Frozen Encoder with Spatial Masking 30% Pre-trained

Evaluates the encoder pre-trained with 30% spatial masking - FROZEN (no fine-tuning).
...
Usage:
    python -c "from basicts import launch_training; launch_training('baselines/ContextContrastive/SAN_BERNARDINO/STAEformer_freeze_spatial_mask_30.py', gpus='0')"
"""
import os
import sys
...
############################## Encoder Configuration (SPATIAL MASKING 30% - FROZEN) ##############################
ENCODER = {
...
CFG = EasyDict()
CFG.DESCRIPTION = 'Ablation: Frozen Encoder with Spatial Masking 30%'
CFG.GPU_NUM = 1
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'STAEformer_SpatialMask30_Freeze'
