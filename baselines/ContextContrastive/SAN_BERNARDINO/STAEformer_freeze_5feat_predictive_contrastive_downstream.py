"""Downstream with Predictive Contrastive Pretrained Encoder (5feat, d=64)

Single TransformerEncoder pretrained with predictive contrastive loss.
Frozen encoder -> STAEformer downstream.

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/ContextContrastive/SAN_BERNARDINO/STAEformer_freeze_5feat_predictive_contrastive_downstream.py', gpus='0')"
"""
import os, sys
...
CFG_ENCODER = {
    ...
    'source': 'pretrained',
    'freeze': True,
    'ckpt_path': 'checkpoints/PredictiveContrastive_5feat_3mo/xtraffic_SAN_BERNARDINO_12_12/*/PredictiveContrastive_5feat_3mo_best_val*MAE.pt',
    'input_dim': 5,
    'd_model': D_MODEL,
    'num_layers': 2,
    'nhead': 4,
...
MODEL_PARAM = {
    ...
    "input_dim": D_MODEL + 2,  # encoder(64) + tod + dow = 66
    "output_dim": 1,
    "steps_per_day": 288,
...
CFG = EasyDict()
CFG.DESCRIPTION = 'Predictive Contrastive Pretrained -> Frozen -> STAEformer (d=64)'
CFG.GPU_NUM = 1
...
CFG.MODEL = EasyDict({
    'NAME': 'STAEformer_5feat_predictive_contrastive_downstream_3mo',
    'ARCH': STAEformer,
    'PARAM': MODEL_PARAM,
