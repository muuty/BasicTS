"""STAEformer with FROZEN Disentangled Encoder (V1 - No Orthogonality)

Uses encoder pretrained with disentangled representation learning.
z_context (Transformer) + z_self (MLP) -> concat -> downstream

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/ContextContrastive/SAN_BERNARDINO/STAEformer_freeze_disentangled_v1.py', gpus='0')"
"""
import os, sys
...
CFG_ENCODER = {
    ...
    'source': 'pretrained',
    'freeze': True,
    'ckpt_path': 'checkpoints/Disentangled_v1_3mo/xtraffic_SAN_BERNARDINO_12_12/*/Disentangled_v1_3mo_best_val*MAE.pt',
    'input_dim': 3,
    'd_model': D_MODEL,
    'num_layers': 2,
    'nhead': 4,
...
CFG = EasyDict()
CFG.DESCRIPTION = 'STAEformer + FROZEN Disentangled Encoder V1 (No Ortho)'
CFG.GPU_NUM = 1
...
CFG.MODEL = EasyDict({
    'NAME': 'STAEformer_freeze_disentangled_v1_3mo',
    'ARCH': STAEformer,
    'PARAM': MODEL_PARAM,
