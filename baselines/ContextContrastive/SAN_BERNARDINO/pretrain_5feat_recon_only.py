"""Q2 Ablation: Pretrain with Reconstruction Loss ONLY (5feat)

contrastive_weight=0, reconstruction_weight=1

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/ContextContrastive/SAN_BERNARDINO/pretrain_5feat_recon_only.py', gpus='0')"
"""
import os, sys
...
MODEL_PARAM = {
    ...
    'contrastive_weight': 0.0,   # OFF
    'reconstruction_weight': 1.0,
}

CFG = EasyDict()
CFG.DESCRIPTION = 'Q2 Ablation: Reconstruction Only Pretrain (5feat)'
CFG.GPU_NUM = 1
CFG.RUNNER = DisentangledTemporalRunner
CFG.PRETRAIN = {'contrastive_weight': 0.0, 'reconstruction_weight': 1.0}
...
CFG.MODEL = EasyDict({
    'NAME': 'DisentangledTemporal_5feat_recon_only_3mo',
