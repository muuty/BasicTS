"""STAEformer with FROZEN Spatial Masking 70% Pretrained Encoder"""
import os, sys
...
CFG_ENCODER = {
    ...
    'ckpt_path': 'checkpoints/ContextContrastive_spatial_mask70pct_3mo/xtraffic_SAN_BERNARDINO_12_12/*/ContextContrastive_spatial_mask70pct_3mo_best_val*MAE.pt',
...
CFG = EasyDict()
CFG.DESCRIPTION = 'STAEformer + FROZEN Spatial Mask 70% Encoder'
CFG.GPU_NUM = 1
...
CFG.MODEL = EasyDict({'NAME': 'ContextContrastive_freeze_spatial_mask70pct_3mo', 'ARCH': STAEformer, 'PARAM': MODEL_PARAM, 'FORWARD_FEATURES': [0, 3, 4], 'TARGET_FEATURES': [0]})
