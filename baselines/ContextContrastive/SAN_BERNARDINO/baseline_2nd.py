"""
Baseline 2nd Run: STAEformer for SAN_BERNARDINO with Incident Evaluation

Re-run of STAEformer baseline to verify reproducibility.

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/ContextContrastive/SAN_BERNARDINO/baseline_2nd.py', gpus='0')"
"""
import os
import sys
...
CFG = EasyDict()
CFG.DESCRIPTION = 'Baseline 2nd Run: STAEformer with Incident Evaluation (reproducibility check)'
CFG.GPU_NUM = 1
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'STAEformer_Baseline_2nd'
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    'checkpoints',
    'ContextContrastive_baseline-2nd_3mo',
