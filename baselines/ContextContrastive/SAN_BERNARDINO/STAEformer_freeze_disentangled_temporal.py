"""STAEformer with FROZEN Disentangled + Temporal-Aware Encoder

Uses encoder pretrained with:
- z_context: Temporal-Aware Contrastive Loss
- z_self: Reconstruction Loss

z_context + z_self -> concat -> downstream STAEformer

Usage:
    python -c "from basicts import launch_training; launch_training('baselines/ContextContrastive/SAN_BERNARDINO/STAEformer_freeze_disentangled_temporal.py', gpus='0')"
"""
import os, sys
...
CFG_ENCODER = {
    ...
    'source': 'pretrained',
    'freeze': True,
    'ckpt_path': 'checkpoints/DisentangledTemporal_3mo/xtraffic_SAN_BERNARDINO_12_12/*/DisentangledTemporal_3mo_best_val*MAE.pt',
    'input_dim': 3,
    'd_model': D_MODEL,
    'num_layers': 2,
    'nhead': 4,
...
CFG = EasyDict()
CFG.DESCRIPTION = 'STAEformer + FROZEN Disentangled Temporal (Contrastive+Recon)'
CFG.GPU_NUM = 1
...
CFG.MODEL = EasyDict({
    'NAME': 'STAEformer_freeze_disentangled_temporal_3mo',
    'ARCH': STAEformer,
    'PARAM': MODEL_PARAM,
