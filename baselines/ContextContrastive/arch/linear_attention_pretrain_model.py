"""
Pre-training model for LinearAttentionDenoisingEncoder.

Same noise injection + denoising objective as DenoisingPretrainModel,
but uses LinearAttentionDenoisingEncoder instead of DenoisingEncoder.
"""
...
class LinearAttentionPretrainModel(nn.Module):
    ...
    def __init__(
        ...
        self.noise_types = noise_types or ['gaussian', 'bias', 'drift', 'dead']
        self.clean_prob = clean_prob

        self.encoder = LinearAttentionDenoisingEncoder(
            input_dim=input_dim,
            d_model=d_model,
