#!/usr/bin/env python3
"""
Federated Learning + STGformer Configuration for PEMS03 Dataset

Usage:
    python experiments/train.py -c baselines/FederatedLearning/STGformer-PEMS03.py -g 0
"""
...
from ...STGformer.arch import STGformer
...
# Adjacency matrix (STGformer는 supports 형태로 사용)
adj_mx, _ = load_adj("datasets/" + DATA_NAME + "/adj_mx.pkl", "normlap")
supports = [torch.tensor(i) for i in adj_mx]

# 베이스 모델 파라미터 (STGformer)
BASE_MODEL_PARAMS = {
    "num_nodes": NUM_NODES,
    "in_steps": INPUT_LEN,
...
MODEL_PARAM = {
    ...
    "adj_matrix": None,  # STGformer는 supports를 직접 사용
    "client_nodes_list": None,
}

############################## General Configuration ##############################
CFG = EasyDict()
CFG.DESCRIPTION = f'FederatedLearning + STGformer on {DATA_NAME}'
CFG.GPU_NUM = 1
...
############################## Model Configuration ##############################
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = f'FedAvg_STGformer'
...
CFG.TRAIN.OPTIM.PARAM = {"lr": 0.001, "weight_decay": 0.0015}
