#!/usr/bin/env python3
"""
Federated Learning + STGformer Configuration for PEMS04 Dataset

Usage:
    python experiments/train.py -c baselines/FederatedLearning/STGformer-PEMS04.py -g 0
"""
...
CFG.TRAIN.OPTIM.PARAM = {"lr": 0.001, "weight_decay": 0.001}
