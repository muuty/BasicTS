"""STAEformer source model with Masked Node PT + Learnable Default Embedding.

During training, 20% of nodes' adaptive_embedding is replaced with a learnable
default_embedding (initialized to zero). The model learns the optimal "unknown node"
representation. For new node initialization, use this learned default.
"""
import os
import sys
import numpy as np
...
MODEL_PARAM = {
    ...
    "use_mixed_proj": True,
    "node_mask_ratio": 0.2,
    "learnable_default": True,
}

CFG = EasyDict()
CFG.DESCRIPTION = "STAEformer Masked PT + Learnable Default - 558 nodes - 2023 Q1"
CFG.GPU_NUM = 1
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    "checkpoints", "Expanding_Source_MaskedPT_Learnable",
