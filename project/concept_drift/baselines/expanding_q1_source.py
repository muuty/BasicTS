"""STAEformer source model: 558 nodes (5/8) on 2023 Q1 for expanding sensor experiment."""
import os
import sys
import numpy as np
...
CFG = EasyDict()
CFG.DESCRIPTION = "STAEformer Source 558 nodes (5/8) - 2023 Q1 (expanding experiment)"
CFG.GPU_NUM = 1
